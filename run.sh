...
python tools/demo.py image -n yolox-s -c /home/deepmirror/Downloads/yolox_s.pth --path /home/deepmirror/work/04.dataset/PlaceRecognition/temp  --conf 0.25 --nms 0.45 --tsize 640 --save_result --device gpu
